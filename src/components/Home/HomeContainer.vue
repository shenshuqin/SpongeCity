    ...
    <div class="main">
        ...
        <div class="row">
          ...
          <div class="sec_main">
            ...
            <div class="right col-md-6">
              ...
              <p
                class="right_cot"
              >构建低影响开发雨水系统，规划控制目标一般包括径流总量控制、径流峰值控制、径流污染控制、雨水资源化利用等。各地应结合水环境现状、水文地质条件等特点，合理选择其中一项或多项目标作为规划控制目标。鉴于径流污染控制目标、 雨水资源化利用目标大多可通过径流总量控制实现， 各地低影响开发雨水系统构建可选择径流总量控制作为首要的规划控制目标。</p>
      ...
      <div class="contentpart">
        <div class>
          <div class="picture">
            <picture>
              <source type="image/webp" srcset="../../public/images/bg.webp" />
              <img class="image" src="../../public/images/bg.webp" />
            </picture>
          </div>
          <div class="indexabout text-center">
            <h4 style="font-size: 18px">项目简介</h4>
                ...
                <div class="row sec3_main">
                  ...
                  <div class="col-md-3 item">
                    <div class="youshipart text-center">
                      ...
                      <h3>可靠的实力</h3>
                      <div class="word">专注海绵城市，多年产品研发经验，众多项目实例积淀，流程规范化管理，技术实力遥遥领先。</div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3 item">
                    <div class="youshipart text-center">
                      ...
                      <h3>长远发展眼光</h3>
                      <div class="word">不断完善和改进现有产品服务的同时，开拓海绵城市理念的新领域，挖掘新技术，扩展新市场。</div>
                    </div>
                  </div>
                </div>
              </div>
...
.el-carousel__item:nth-of-type(1) {
  background: url("http://hlimgserver.oss-cn-shanghai.aliyuncs.com/img/slide2.png");
  background-size: 100% 100%;
}
.el-carousel__item:nth-of-type(2) {
  background: url("http://hlimgserver.oss-cn-shanghai.aliyuncs.com/img/slide1.png");
  background-size: 100% 100%;
}
