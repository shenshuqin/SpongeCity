    ...
    export default {
        ...
        methods: {
            ...
            getdata_temp(this_ = this) {
                axios({
                    // url: 'http://121.199.42.23:8080/sponge/data/sensor?sensor_id=3',
                    url: 'http://121.199.42.23:8080/sponge/avg_data/sensor?sensor_id=3',
                    method: 'get',
                    type: 'json',
            ...
            getdata_hum(this_ = this) {
                axios({
                    // url: 'http://121.199.42.23:8080/sponge/data/sensor?sensor_id=4',
                    url: 'http://121.199.42.23:8080/sponge/avg_data/sensor?sensor_id=4',
                    method: 'get',
                    type: 'json',
                    headers: this_.my_header
                }).then(function (res) {
